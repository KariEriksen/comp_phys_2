...
\begin{equation*}
E_L = \sum_{i}^{M} \frac{1}{2} \left( -\frac{1}{\Psi} \frac{\partial^2}{\partial X_{i}^2} \Psi +  \frac{1}{\Psi} \omega^2 X_i^2 \right) + \frac{1}{\Psi} \sum_{k < l} \frac{1}{r_{kl}}
\end{equation*}
...
\begin{equation*}
E_L = \sum_{i}^{M} \frac{1}{2} \left( - \left( \frac{\partial}{\partial X_{i}} \ln \Psi \right)^2 + \frac{\partial^2}{\partial X_{i}^2} \ln \Psi  +  \frac{1}{\Psi} \omega^2 X_i^2 \right) + \frac{1}{\Psi} \sum_{k < l} \frac{1}{r_{kl}}
\end{equation*}
